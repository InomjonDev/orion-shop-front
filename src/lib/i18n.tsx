...
const en: Dict = {
  ...
  'checkout.verifyPhoneReq': 'Please verify your phone number before ordering.',
  'checkout.phoneUnverified': 'Your phone number isn’t verified yet.',
  'checkout.verifyNow': 'Verify your phone',
  ...
  'profile.verifyTelegram': 'Verify phone via Telegram',
  'profile.verifyHint': 'Opens Telegram — tap “Share my phone number”. Telegram verifies the number, no SMS needed.',
  'profile.waiting': 'Waiting for confirmation…',
  'profile.verifiedToast': 'Phone number verified.',
  'profile.verifyRequired': 'Please verify your phone number first.',
  'profile.verifyTest': 'Verify',
  'profile.verifyTestHint': 'Local preview only — on the live site this is done through Telegram.',
  'order.view': 'View',
...
const ru: Dict = {
  ...
  'checkout.verifyPhoneReq': 'Подтвердите номер телефона перед заказом.',
  'checkout.phoneUnverified': 'Ваш номер телефона ещё не подтверждён.',
  'checkout.verifyNow': 'Подтвердить номер',
  ...
  'profile.phoneVerified': 'Подтверждён',
  'profile.verifyTelegram': 'Подтвердить номер через Telegram',
  'profile.verifyHint': 'Откроется Telegram — нажмите «Поделиться номером». Номер подтверждает Telegram, SMS не нужен.',
  'profile.waiting': 'Ожидание подтверждения…',
  'profile.verifiedToast': 'Номер телефона подтверждён.',
  'profile.verifyRequired': 'Сначала подтвердите номер телефона.',
  'profile.verifyTest': 'Подтвердить',
  'profile.verifyTestHint': 'Локальный просмотр — на реальном сайте подтверждение через Telegram.',
  'order.view': 'Открыть',
...
const uz: Dict = {
  ...
  'checkout.verifyPhoneReq': 'Buyurtma berishdan oldin raqamingizni tasdiqlang.',
  'checkout.phoneUnverified': 'Telefon raqamingiz hali tasdiqlanmagan.',
  'checkout.verifyNow': 'Raqamni tasdiqlash',
  ...
  'profile.phoneVerified': 'Tasdiqlangan',
  'profile.verifyTelegram': 'Telegram orqali raqamni tasdiqlash',
  'profile.verifyHint': 'Telegram ochiladi — “Raqamni ulashish” tugmasini bosing. Raqamni Telegram tasdiqlaydi, SMS shart emas.',
  'profile.waiting': 'Tasdiqlash kutilmoqda…',
  'profile.verifiedToast': 'Telefon raqami tasdiqlandi.',
  'profile.verifyRequired': 'Avval telefon raqamingizni tasdiqlang.',
  'profile.verifyTest': 'Tasdiqlash',
  'profile.verifyTestHint': 'Mahalliy koʻrish — haqiqiy saytda bu Telegram orqali amalga oshiriladi.',
  'order.view': 'Ochish',
