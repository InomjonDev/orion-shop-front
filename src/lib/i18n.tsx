...
const en: Dict = {
  ...
  'auth.title': 'Sign in',
  'auth.subtitle': 'Enter your phone number to get a login code by SMS.',
...
const ru: Dict = {
  ...
  'auth.title': 'Вход',
  'auth.subtitle': 'Введите номер телефона — пришлём код по SMS.',
...
const uz: Dict = {
  ...
  'auth.title': 'Kirish',
  'auth.subtitle': 'Telefon raqamingizni kiriting — SMS orqali kod yuboramiz.',
